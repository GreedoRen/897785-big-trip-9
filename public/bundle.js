...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_info__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/info */ "./src/components/info.js");
...
/* harmony import */ var _components_eventList__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/eventList */ "./src/components/eventList.js");
...
/* harmony import */ var _components_eventEditor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/eventEditor */ "./src/components/eventEditor.js");
...
render(tripInfoSection, Object(_components_info__WEBPACK_IMPORTED_MODULE_0__["Info"])(), `afterbegin`);

const tripControlsHeadings = document.querySelectorAll(`.trip-main__trip-controls h2`);
render(tripControlsHeadings[0], Object(_components_menu__WEBPACK_IMPORTED_MODULE_1__["Menu"])(), `afterend`);
render(tripControlsHeadings[1], Object(_components_filter__WEBPACK_IMPORTED_MODULE_2__["Filters"])(), `afterend`);

const eventListTempContainer = document.createElement(`div`);
render(eventListTempContainer, Object(_components_eventList__WEBPACK_IMPORTED_MODULE_4__["EventList"])());

const tripEventsList = eventListTempContainer.querySelector(` ul.trip-events__list`);
render(tripEventsList, Object(_components_eventEditor__WEBPACK_IMPORTED_MODULE_6__["EventEdit"])());
for (let i = 3; i > 0; i--) {
	render(tripEventsList, Object(_components_event__WEBPACK_IMPORTED_MODULE_5__["Event"])());
}

const tripEventsSection = document.querySelector(`section.trip-events`);
render(tripEventsSection, Object(_components_sort__WEBPACK_IMPORTED_MODULE_3__["Sort"])() + eventListTempContainer.innerHTML);
